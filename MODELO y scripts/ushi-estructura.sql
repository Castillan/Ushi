...
-- -----------------------------------------------------
-- Table `ushi`.`Educacion`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ushi`.`Educacion` (
...
-- Table `ushi`.`Grado`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ushi`.`Grado` (
...
CREATE  TABLE IF NOT EXISTS `ushi`.`NivelEducativo` (
  ...
  INDEX `fk_Educacion_has_Grado_Grado1_idx` (`Grado_idGrado` ASC) ,
  INDEX `fk_Educacion_has_Grado_Educacion1_idx` (`Educacion_idEducacion` ASC) ,
  PRIMARY KEY (`idNivelEducativo`) ,
  UNIQUE INDEX `uc_grado_educacion` (`Educacion_idEducacion` ASC, `Grado_idGrado` ASC) ,
  CONSTRAINT `fk_Eduacion_has_Grado_Eduacion1`
    FOREIGN KEY (`Educacion_idEducacion` )
    REFERENCES `ushi`.`Educacion` (`idEducacion` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Eduacion_has_Grado_Grado1`
    FOREIGN KEY (`Grado_idGrado` )
    REFERENCES `ushi`.`Grado` (`idGrado` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
