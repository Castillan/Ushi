...
CREATE  TABLE IF NOT EXISTS `ushi`.`NivelEducativo` (
  ...
  UNIQUE INDEX `uc_grado_educacion` (`Nivel_Educativo` ASC) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `ushi`.`Trabajador` (
  ...
  `Grado_Educacion` VARCHAR(45) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `ushi`.`Notas` (
  ...
  `Nota1` VARCHAR(170) NULL ,
  `Nota2` VARCHAR(170) NULL ,
  `Nota3` VARCHAR(170) NULL ,
  `Burbuja` VARCHAR(120) NULL ,
  PRIMARY KEY (`idNotas`) )
ENGINE = InnoDB;
