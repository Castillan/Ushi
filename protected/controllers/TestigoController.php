...
class TestigoController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Testigo']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idTestigo));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Testigo');
	...
	{
		$model=new Testigo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Testigo']))
			$model->attributes=$_GET['Testigo'];
	 ...
	 * @param Testigo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='testigo-form')
		{
