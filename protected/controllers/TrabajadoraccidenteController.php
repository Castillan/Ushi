...
class TrabajadoraccidenteController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Trabajadoraccidente']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idTrabajadorAccidente));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Trabajadoraccidente');
	 ...
	 * @return Trabajadoraccidente the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Trabajadoraccidente::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Trabajadoraccidente $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='trabajadoraccidente-form')
		{
